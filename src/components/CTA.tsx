            ...
            {sent ? (
              ...
              <>
                ...
                <div className="grid sm:grid-cols-2 gap-3 mb-3">
                  <input type="text" placeholder="Your name *" value={name} onChange={(e) => setName(e.target.value)} className="w-full px-4 sm:px-5 py-3 rounded-xl bg-background border border-charcoal-light text-foreground placeholder:text-muted/50 focus:outline-none focus:border-amber/50 transition-colors text-sm" />
                  <input type="email" placeholder="Email address *" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full px-4 sm:px-5 py-3 rounded-xl bg-background border border-charcoal-light text-foreground placeholder:text-muted/50 focus:outline-none focus:border-amber/50 transition-colors text-sm" />
                </div>
                <div className="grid sm:grid-cols-2 gap-3 mb-3">
                  <input type="tel" placeholder="Phone (optional)" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full px-4 sm:px-5 py-3 rounded-xl bg-background border border-charcoal-light text-foreground placeholder:text-muted/50 focus:outline-none focus:border-amber/50 transition-colors text-sm" />
                  <CustomSelect
